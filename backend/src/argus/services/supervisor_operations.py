    ...
    async def record_runtime_report(
        ...
        *,
        ...
        row = WorkerRuntimeReport(
            ...
            processing_fps_cap=payload.processing_fps_cap,
            output_fps=payload.output_fps,
            stream_profile_id=payload.stream_profile_id,
            tracking_diagnostics=dict(payload.tracking_diagnostics),
...
def supervisor_runtime_report_response(
    ...
    return SupervisorRuntimeReportResponse(
        ...
        processing_fps_cap=row.processing_fps_cap,
        output_fps=row.output_fps,
        stream_profile_id=row.stream_profile_id,
        tracking_diagnostics=dict(row.tracking_diagnostics or {}),
